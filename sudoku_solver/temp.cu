...
//
//__device__ bool is_valid_board(const char* board)
//{
...
//                    {
//                        // ???
//                        int next_board_ind = atomicAdd(board_index, 1) + 1;
//                        int empty_index = 0;
//
//                        for (int j = 0; j < N; j++)
//                        {
...
//}
//
//__global__ void backtrack_kernel(char* boards, int boards_count , int* empty_spaces, int* empty_spaces_count, int* finished, char* solved)
//{
...
//        cur_empty_spaces_count = empty_spaces[index];
//
//        while ((empty_ind >= 0) && (empty_ind < cur_empty_spaces_count))
//        {
...
//            }
//        }
//        if (empty_ind == cur_empty_spaces_count)
//        {
//            *finished = 1;
//
//            for (int i = 0; i < N; i++)
...
//    check_cuda_error(cudaMemset(d_new_boards, 0, max_bfs * sizeof(char)));
//
